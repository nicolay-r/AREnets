...
from tests.labels import TestPositiveLabel, TestNegativeLabel
from tests.news import init_rusentrel_doc
...
class TestTfInputFeatures(unittest.TestCase):
    ...
    # TODO. This is not a part of the logic of this project (#7 issue).
    # TODO. This is not a part of the logic of this project
    # TODO. This is not a part of the logic of this project
    @classmethod
    def setUpClass(cls):
    ...
    def test(self):
        ...
        for doc_id in [35, 36]: # RuSentRelIOUtils.iter_collection_indices():
            ...
            for text_opinion in text_opinion_iter:
                ...
                # TODO. Till here, we just consider only input terms and that is it.
                # TODO. Till here, we just consider only input terms and that is it.
                # TODO. Till here, we just consider only input terms and that is it.
